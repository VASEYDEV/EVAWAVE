...
- **Design source of truth:** the Vasey Multimedia Brand System v2.0 (ADR 0005; `docs/design/reference/`), applied in `docs/design/brand-application.md`. CORE colours only, BEAM once per page, three typefaces. A new colour requires a retirement.
