...
- [SPEC](SPEC.md): product scope and decisions (A1–A16), MusicSpec IR v1 with the
  "Defined, not inherited" list, lint rules, and the build plan S1–S7.
...
- Decisions: [ADR 0001](decisions/0001-repo-bootstrap.md),
  ...
  [ADR 0005](decisions/0005-brand-system-v2.md) (brand system),
  [ADR 0006](decisions/0006-songs-and-variants.md) (songs and variants).
