...
Heads-up for this product: prompt and tag templates commonly use double-brace
interpolation. If the stack introduces such templates before the gate is replaced, scope
the placeholder check to documentation paths rather than deleting it.
